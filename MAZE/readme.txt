...
\
Libraries:\
No external libraries, all necessary external files are included(really only debounder.py, which is not of my own creation)\
\
Shortcut commands not available. \
\
I focused much on the user experience, the player shouldn\'92t be able to do something that developer related and so long as main.py is ran a user should be able to see all that\'92s intended to be seen.}